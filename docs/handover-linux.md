...
**Nothing is being asked of the Linux box.** Which is the finished state rather than an oversight: items
1 through 9 are done and their answers are in the files that hold facts, not here. This file is the
asking, and it is meant to empty.
